    ...
    <div className="space-y-8 pb-16">
      ...
      {isQuizListOpen && (
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-slate-950/80 backdrop-blur-md" onClick={() => setIsQuizListOpen(false)} />
          <div className="relative w-full max-w-md bg-[#131b2e] border border-white/15 rounded-3xl overflow-hidden shadow-2xl z-10 text-white">
            <div className="p-6 border-b border-white/10 flex justify-between items-center">
              ...
              <button onClick={() => setIsQuizListOpen(false)} className="p-1 rounded-full bg-white/5 hover:bg-white/10 text-slate-300">
                <X className="w-5 h-5" />
              </button>
            </div>
